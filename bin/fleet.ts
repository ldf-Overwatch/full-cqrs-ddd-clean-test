...
const argv = yargs
  ...
  .command(
    ...
    'register a vehicle into a fleet',
    (yargs: any) => {
      return yargs
        .positional('fleetId', {
    ...
    async (argv: { fleetId: string; vehiclePlateNumber: string }) => {
      ...
      const vehicleCreateCommand = new VehicleCreateCommands(
        Vehicle.create({ type: 'car', vehiclePlateNumber: argv.vehiclePlateNumber }),
      );
  ...
  .command(
    'localize-vehicle <fleetId> <vehiclePlateNumber> lat long [alt]',
    'localize a vehicle into a fleet',
    (yargs: any) => {
      return yargs
        .positional('fleetId', {
          describe: 'fleetId of fleet',
